			...
			<div class="col"
				...
				<div class="card-title" style="margin-top: 30px;">
					<h2 class="card-title text-center"
						style="font-size: x-large;">신규상품 등록</h2><br><br>
				</div>
				<div class="card-body">
					<form action="menu_insert" method="post">
						<label>상품명 : </label><input type="text" name="menu_name" class="form-control" ><br> 가격 : <input
							type="text" name="menu_price" class="form-control" ><br> 분류 : <select
							name="menu_category" class="form-control" >
							<option>메인</option>
							<option>반찬</option>
							<option>김치</option>
							<option>국</option>
							<option>육류</option>
							<option>샐러드</option>
						</select><br> 이미지 : <input type="file" name="menu_image" class="form-control" ><br>
						<br> <input type="submit" value="등록" style="border-style:solid 3px;">
					</form>
				</div>
			</div>
